...
| [development-handoff.md](../../templates/architecture/development-handoff.md) | The development-ready package at the DESIGN exit: each section links the artifact that carries it |
...
| [design-review-record.md](../../templates/architecture/design-review-record.md) | The one signed record of an experience-design review, across two gates |
| [localisation-rtl-checklist.md](../../templates/architecture/localisation-rtl-checklist.md) | A walkable localisation and bidi checklist for a right-to-left or multilingual UI |
| [component-spec.md](../../templates/architecture/component-spec.md) | One shared component's specification, written only when two or more surfaces use it |
| [design-md.md](../../templates/architecture/design-md.md) | The product's own DESIGN.md: tokens, components, content, and accessibility rules |
...
| [heuristic-evaluation.md](../../frameworks/design/heuristic-evaluation.md) | Run a runnable heuristic evaluation, with a task-based variant | Jakob Nielsen's ten usability heuristics (1994) |
| [content-microcopy-audit.md](../../frameworks/design/content-microcopy-audit.md) | Inventory and rule-check every string on a screen | UK Government Digital Service content design practice |
| [design-system-audit.md](../../frameworks/design/design-system-audit.md) | Inventory and health-audit a design system as one product consumes it | US Web Design System maturity model and GOV.UK Design System component lifecycle |

Knowledge behind the methods: [cagan-product-teams.md](../../knowledge/cagan-product-teams.md) for the feasibility and viability risks, and [domains/ai-products.md](../../knowledge/domains/ai-products.md) when a model sits inside the product. Experience design (how a PM reads and judges it, not the DESIGN stage): [knowledge/design/accessibility-and-inclusive-design.md](../../knowledge/design/accessibility-and-inclusive-design.md), [knowledge/design/internationalisation-and-rtl.md](../../knowledge/design/internationalisation-and-rtl.md), [knowledge/design/usability-heuristics.md](../../knowledge/design/usability-heuristics.md), [knowledge/design/visual-foundations.md](../../knowledge/design/visual-foundations.md), [knowledge/design/design-systems-and-tokens.md](../../knowledge/design/design-systems-and-tokens.md), [knowledge/design/ui-dependency-licensing.md](../../knowledge/design/ui-dependency-licensing.md). The full index is [knowledge/README.md](../../knowledge/README.md).
...
| [design-review](../../skills/design-review/SKILL.md) | A design review, a heuristic evaluation or cognitive walkthrough, or an accessibility, content, localisation, or deceptive-design pass on a flow is due |
...
- Templates: [[templates/architecture/system-design.md]] · [[templates/architecture/solution-architecture.md]] · [[templates/architecture/adr.md]] · [[templates/architecture/data-model.md]] · [[templates/architecture/api-contract.md]] · [[templates/architecture/development-handoff.md]] · [[templates/architecture/sequence-diagram.md]] · [[templates/architecture/integrations.md]] · [[templates/architecture/security-architecture.md]] · [[templates/architecture/observability.md]] · [[templates/architecture/privacy-impact-assessment.md]] · [[templates/architecture/accessibility-checklist.md]] · [[templates/architecture/design-review-record.md]] · [[templates/architecture/localisation-rtl-checklist.md]] · [[templates/architecture/component-spec.md]] · [[templates/architecture/design-md.md]] · [[templates/execution/stakeholder-map.md]] · [[templates/execution/risk-register.md]] · [[templates/execution/decision-log.md]] · [[templates/execution/dependency-register.md]] · [[templates/execution/state.md]]
- Overlay templates: [[templates/ai/agent-architecture.md]] · [[templates/ai/guardrails.md]] · [[templates/ai/red-team-review.md]]
- Frameworks: [[frameworks/execution/premortem-worksheet.md]] · [[frameworks/execution/risk-matrix.md]] · [[frameworks/execution/raci.md]] · [[frameworks/execution/stakeholder-power-interest.md]] · [[frameworks/strategy/build-buy-partner.md]] · [[frameworks/assessment/team-topologies-assessment.md]] · [[frameworks/assessment/tech-debt-assessment.md]] · [[frameworks/execution/fmea.md]] · [[frameworks/design/heuristic-evaluation.md]] · [[frameworks/design/content-microcopy-audit.md]] · [[frameworks/design/design-system-audit.md]]
- Knowledge: [[knowledge/cagan-product-teams.md]] · [[knowledge/domains/ai-products.md]] · [[knowledge/README.md]] · [[knowledge/design/accessibility-and-inclusive-design.md]] · [[knowledge/design/internationalisation-and-rtl.md]] · [[knowledge/design/usability-heuristics.md]] · [[knowledge/design/visual-foundations.md]] · [[knowledge/design/design-systems-and-tokens.md]] · [[knowledge/design/ui-dependency-licensing.md]]
- Skills: [[skills/program-premortem/SKILL.md]] · [[skills/spec-review/SKILL.md]] · [[skills/decision-memo/SKILL.md]] · [[skills/escalation/SKILL.md]] · [[skills/design-review/SKILL.md]] · [[skills/conductor/questions/design.md]]
