...
- **Reflow.** Content re-laying-out to a single column at high zoom instead of requiring two-dimensional scrolling, the WCAG 2.2 test for whether zoomed content stays usable. See [knowledge/design/visual-foundations.md](knowledge/design/visual-foundations.md).
