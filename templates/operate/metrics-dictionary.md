...
Filled example: [Expense Copilot Add-on](../../examples/ledgerline-metrics-dictionary.md)
Filled example: [Kestrion Demand-Side Platform](../../examples/domain-martech-adtech-metrics-dictionary.md)
