...
Filled example: [Northline Talent resume-ranking model](../../examples/domain-hr-tech-eval-spec.md)
Filled example: [Sentinel adverse-event case triage](../../examples/domain-pharma-life-sciences-eval-spec.md)
