...
Filled example: [Expense Copilot](../../examples/expense-copilot-data-model.md)
Filled example: [Statute & Sage Contract Review](../../examples/domain-legaltech-data-model.md)
