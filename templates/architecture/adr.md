...
Filled example: [Extract fields from one receipt per model call, never batch multiple receipts into one call](../../examples/expense-copilot-adr.md)
Filled example: [Route every card payment through Kestrel from Quay and retire the Marlowe and Tidewater integrations](../../examples/harbourgate-adr.md)
