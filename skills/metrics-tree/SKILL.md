...
- See also [../../frameworks/systems/causal-loop-diagram.md](../../frameworks/systems/causal-loop-diagram.md) (Forrester, 1961) when an input grew and then went flat, and [../../frameworks/metrics/space-framework.md](../../frameworks/metrics/space-framework.md) (Forsgren, Storey, and colleagues, 2021) when the metric being asked for is team productivity. The tree assumes an input moves when a team pushes on it; a flat input under steady effort means something is pushing back, and the loop diagram is where the ceiling and the delay are, not the dictionary
