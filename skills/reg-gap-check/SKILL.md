...
- [../../modules/regulated/README.md](../../modules/regulated/README.md#when-this-overlay-activates), which names the canonical source and states the same condition, as a truth table; the narrowed rule in [../../os/STAGE-GATES.md](../../os/STAGE-GATES.md) governs, and the overlay activates only when the product contains an AI or machine-learning feature and a financial or data regulator applies to it
