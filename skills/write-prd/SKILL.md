...
- Hands off, not overlaps: [../story-writer/SKILL.md](../story-writer/SKILL.md) for epics and criteria once stories are signed, [../ai-prd/SKILL.md](../ai-prd/SKILL.md) the moment the implementer is a model, [../reg-gap-check/SKILL.md](../reg-gap-check/SKILL.md) the moment a regulator is in scope, carrying [../../modules/regulated/README.md](../../modules/regulated/README.md) only where the product also contains an AI or machine-learning feature, which is the rule in [../../os/STAGE-GATES.md](../../os/STAGE-GATES.md), and [../spec-review/SKILL.md](../spec-review/SKILL.md) for the writing check this skill runs before Gate 2
