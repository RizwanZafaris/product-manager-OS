...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [personas](../../templates/discovery/personas.md) (1), [journey-map](../../templates/discovery/journey-map.md) (1), [integrations](../../templates/architecture/integrations.md) (2), [north-star-metric](../../templates/planning/north-star-metric.md) (2). No filled example in this repository was written for this domain; the examples above fill the same templates for other products. This paragraph is generated by `python3 tools/example_availability.py`.
