...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [nfr](../../templates/definition/nfr.md) (9), [integrations](../../templates/architecture/integrations.md) (2), [failure-scenarios](../../templates/delivery/failure-scenarios.md) (6), [release-readiness](../../templates/delivery/release-readiness.md) (3). Written for this domain: [domain-hardware-iot-nfr.md](../../examples/domain-hardware-iot-nfr.md). Filled examples of [integrations](../../templates/architecture/integrations.md), [failure-scenarios](../../templates/delivery/failure-scenarios.md), [release-readiness](../../templates/delivery/release-readiness.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
