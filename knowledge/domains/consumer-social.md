...
**Example availability (generated).** Of the 2 templates this card bends, 2 have a filled example somewhere in this repository: [failure-scenarios](../../templates/delivery/failure-scenarios.md) (6), [compliance-impact-assessment](../../templates/operate/compliance-impact-assessment.md) (3). Written for this domain: [domain-consumer-social-failure-scenarios.md](../../examples/domain-consumer-social-failure-scenarios.md). Filled examples of [compliance-impact-assessment](../../templates/operate/compliance-impact-assessment.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
