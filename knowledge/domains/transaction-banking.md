...
**Filled in this repo:** [domain-transaction-banking-failure-scenarios.md](../../examples/domain-transaction-banking-failure-scenarios.md) fills the [failure-scenarios](../../templates/delivery/failure-scenarios.md) template directly for this domain, for Westgate Treasury: the FS-4 row on a 2,400-row payroll file where 9 rows fail, a file missing the 16:02 cut-off, a duplicate submission of the same file ID, an expired host-to-host SFTP key, ISO 20022 schema rejections after a scheme migration, and a bank-holiday calendar mismatch, where no scenario may use 'customer report' as its detection and recovery flows through a payment status report back into the client's ERP. For the other three bent templates, [harbourgate-integrations.md](../../examples/harbourgate-integrations.md), [ledgerline-dashboard-spec.md](../../examples/ledgerline-dashboard-spec.md) and [sahulat-personas.md](../../examples/sahulat-personas.md) remain the nearest reading for the counterparty-SLA, audience-question, and evidence-based persona shapes, though none carries a treasurer, clerk, or auditor persona.

<!-- generated: example-availability -->
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [integrations](../../templates/architecture/integrations.md) (2), [failure-scenarios](../../templates/delivery/failure-scenarios.md) (6), [personas](../../templates/discovery/personas.md) (1), [dashboard-spec](../../templates/operate/dashboard-spec.md) (1). Written for this domain: [domain-transaction-banking-failure-scenarios.md](../../examples/domain-transaction-banking-failure-scenarios.md). Filled examples of [integrations](../../templates/architecture/integrations.md), [personas](../../templates/discovery/personas.md), [dashboard-spec](../../templates/operate/dashboard-spec.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
<!-- end generated: example-availability -->

**Worked example (ILLUSTRATIVE):** A bulk-payment scenario row, in the shape of `templates/delivery/failure-scenarios.md` section 1. Every name and number below is invented.
...
The general template's blast radius, detection and recovery columns stay the same shape; what changes is that "customer report" is disqualified as a detection method here, since a client's own payroll clock runs faster than a support ticket.
