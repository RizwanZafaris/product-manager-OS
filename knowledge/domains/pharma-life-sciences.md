...
**Example availability (generated).** Of the 5 templates this card bends, 5 have a filled example somewhere in this repository: [eval-spec](../../templates/ai/eval-spec.md) (2), [testing-strategy](../../templates/delivery/testing-strategy.md) (1), [failure-scenarios](../../templates/delivery/failure-scenarios.md) (6), [release-readiness](../../templates/delivery/release-readiness.md) (3), [compliance-impact-assessment](../../templates/operate/compliance-impact-assessment.md) (3). Written for this domain: [domain-pharma-life-sciences-eval-spec.md](../../examples/domain-pharma-life-sciences-eval-spec.md). Filled examples of [testing-strategy](../../templates/delivery/testing-strategy.md), [failure-scenarios](../../templates/delivery/failure-scenarios.md), [release-readiness](../../templates/delivery/release-readiness.md), [compliance-impact-assessment](../../templates/operate/compliance-impact-assessment.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
