...
**Filled in this repo:** [domain-capital-markets-nfr.md](../../examples/domain-capital-markets-nfr.md) fills the [nfr](../../templates/definition/nfr.md) template directly for this domain, for Tallyhouse Markets' pre-trade risk gateway: every order screened before it is sent, no more than 250 microseconds added at p99, a timed kill-switch drill, and a capacity multiple set against peak message rate, verified by the venue's chief regulatory officer and member-surveillance lead by role, the discipline question 7's latency budget and question 6's tested-under-load bar ask for. For the other three bent templates, [harbourgate-observability.md](../../examples/harbourgate-observability.md) and [harbourgate-release-readiness.md](../../examples/harbourgate-release-readiness.md) remain the nearest reading, for named SLOs with an alerting threshold and a rehearsed rollback timing, though Harbourgate settles a retail card payment, not an order through a matching engine and a CCP. Filled failure-scenarios examples exist elsewhere in this repository, the nearest reading being [harbourgate-failure-scenarios.md](../../examples/harbourgate-failure-scenarios.md); none was written for capital markets, so it carries no matching engine, no CCP and no kill switch.

<!-- generated: example-availability -->
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [nfr](../../templates/definition/nfr.md) (9), [failure-scenarios](../../templates/delivery/failure-scenarios.md) (6), [observability](../../templates/architecture/observability.md) (1), [release-readiness](../../templates/delivery/release-readiness.md) (3). Written for this domain: [domain-capital-markets-nfr.md](../../examples/domain-capital-markets-nfr.md). Filled examples of [failure-scenarios](../../templates/delivery/failure-scenarios.md), [observability](../../templates/architecture/observability.md), [release-readiness](../../templates/delivery/release-readiness.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
<!-- end generated: example-availability -->

**Worked example (ILLUSTRATIVE):** a slice of an [nfr](../../templates/definition/nfr.md) row, in the numbered, sourced style of [harbourgate-nfr.md](../../examples/harbourgate-nfr.md), for a pre-trade risk control (question 2 above).

| Requirement | Target (number) or owner for the number | Measured how and where | Verified by |
|---|---|---|---|
| Market-access pre-trade risk control (Rule 15c3-5 analogue): reject an order exceeding the client's credit or size limit before it reaches the venue | 100% of orders screened pre-send; screening latency adds no more than 250 microseconds at p99 (target, ILLUSTRATIVE N-KS1) | Order-gateway test harness, replayed against the prior trading day's full order flow | Head of Trading Risk, ILLUSTRATIVE name D. Okafor; kill-switch drill log dated ILLUSTRATIVE 2026-quarter |

This is question 6's bar in one row: the kill switch and the pre-trade control are not narrative promises, they carry a measured latency number and a named person who ran the drill, the distinction the card draws between a control and "a plan."
