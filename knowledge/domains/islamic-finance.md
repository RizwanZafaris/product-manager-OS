...
- **A centralized Shariah Advisory Council, where one exists.** Bank Negara Malaysia's Council, established under the Central Bank of Malaysia Act 2009 (sections 51 to 58), issues rulings that Islamic financial institutions must comply with under section 28 of the Islamic Financial Services Act 2013; without a centralized council, expect the opposite instead, two banks offering differently structured "Islamic" products for the same need.
...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [business-rules](../../templates/definition/business-rules.md) (6), [decision-log](../../templates/execution/decision-log.md) (3), [compliance-impact-assessment](../../templates/operate/compliance-impact-assessment.md) (3), [personas](../../templates/discovery/personas.md) (1). Written for this domain: [domain-islamic-finance-decision-log.md](../../examples/domain-islamic-finance-decision-log.md). Filled examples of [business-rules](../../templates/definition/business-rules.md), [compliance-impact-assessment](../../templates/operate/compliance-impact-assessment.md), [personas](../../templates/discovery/personas.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
