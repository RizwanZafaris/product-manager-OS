...
**Example availability (generated).** Of the 2 templates this card bends, 2 have a filled example somewhere in this repository: [gtm-plan](../../templates/planning/gtm-plan.md) (1), [metrics-review](../../templates/operate/metrics-review.md) (2). Written for this domain: [domain-ecommerce-metrics-review.md](../../examples/domain-ecommerce-metrics-review.md). Filled examples of [gtm-plan](../../templates/planning/gtm-plan.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
