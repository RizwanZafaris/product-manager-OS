...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [security-architecture](../../templates/architecture/security-architecture.md) (1), [nfr](../../templates/definition/nfr.md) (9), [failure-scenarios](../../templates/delivery/failure-scenarios.md) (6), [compliance-impact-assessment](../../templates/operate/compliance-impact-assessment.md) (3). Written for this domain: [domain-crypto-digital-assets-nfr.md](../../examples/domain-crypto-digital-assets-nfr.md). Filled examples of [security-architecture](../../templates/architecture/security-architecture.md), [failure-scenarios](../../templates/delivery/failure-scenarios.md), [compliance-impact-assessment](../../templates/operate/compliance-impact-assessment.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
