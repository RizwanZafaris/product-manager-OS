...
**Filled in this repo:** [domain-embedded-finance-baas-integrations.md](../../examples/domain-embedded-finance-baas-integrations.md) fills the [integrations](../../templates/architecture/integrations.md) template directly for this domain, for Fernbridge Finance: the sponsor's programme ledger API at 99.9% monthly with a ledger outage freezing new accounts, the sponsor's compliance review queue as a human integration with an SLA in days, the card processor, the KYC vendor, and ACH through the sponsor, each detail block stating the sponsor's unilateral suspension authority, with a drilled 72-hour sponsor onboarding freeze. For the other three bent templates, [harbourgate-risk-register.md](../../examples/harbourgate-risk-register.md) and [harbourgate-partner-integration-brief.md](../../examples/harbourgate-partner-integration-brief.md) remain the nearest reading, for a single-counterparty-outage risk and a partner's exit terms, though Harbourgate's counterparty is an acquirer, not a licence-holder. A filled [privacy-impact-assessment](../../examples/example-privacy-impact-assessment.md) exists for a workplace check-in feature, useful for the data-inventory and risk-scoring shape only, not an open-banking consent-scope question.

<!-- generated: example-availability -->
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [integrations](../../templates/architecture/integrations.md) (2), [privacy-impact-assessment](../../templates/architecture/privacy-impact-assessment.md) (1), [partner-integration-brief](../../templates/planning/partner-integration-brief.md) (1), [risk-register](../../templates/execution/risk-register.md) (6). Written for this domain: [domain-embedded-finance-baas-integrations.md](../../examples/domain-embedded-finance-baas-integrations.md). Filled examples of [privacy-impact-assessment](../../templates/architecture/privacy-impact-assessment.md), [partner-integration-brief](../../templates/planning/partner-integration-brief.md), [risk-register](../../templates/execution/risk-register.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
<!-- end generated: example-availability -->

**Worked example (ILLUSTRATIVE):** one row of the integrations register, naming the sponsor by role rather than folding it into a generic "payments provider" line:
...
What an ordinary vendor row would not carry: the sponsor's own programme risk-limit (say, USD 40M in outstanding balances, ILLUSTRATIVE) sits beside the SLA, because breaching it is a suspension trigger the sponsor controls unilaterally, not a scaling problem engineering can fix; and the failure clause states what the end customer is told when it is the licence-holder's system, not ours, that is down, since that sentence is what a support agent reads verbatim rather than paraphrases.
