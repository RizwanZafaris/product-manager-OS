...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [nfr](../../templates/definition/nfr.md) (9), [release-readiness](../../templates/delivery/release-readiness.md) (3), [failure-scenarios](../../templates/delivery/failure-scenarios.md) (6), [risk-register](../../templates/execution/risk-register.md) (6). Written for this domain: [domain-automotive-mobility-risk-register.md](../../examples/domain-automotive-mobility-risk-register.md). Filled examples of [nfr](../../templates/definition/nfr.md), [release-readiness](../../templates/delivery/release-readiness.md), [failure-scenarios](../../templates/delivery/failure-scenarios.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
