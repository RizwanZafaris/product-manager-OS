...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [security-architecture](../../templates/architecture/security-architecture.md) (1), [nfr](../../templates/definition/nfr.md) (9), [failure-scenarios](../../templates/delivery/failure-scenarios.md) (6), [incident-postmortem](../../templates/operate/incident-postmortem.md) (1). Written for this domain: [domain-cybersecurity-grc-nfr.md](../../examples/domain-cybersecurity-grc-nfr.md). Filled examples of [security-architecture](../../templates/architecture/security-architecture.md), [failure-scenarios](../../templates/delivery/failure-scenarios.md), [incident-postmortem](../../templates/operate/incident-postmortem.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
