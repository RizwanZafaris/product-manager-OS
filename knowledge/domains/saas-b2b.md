...
**Example availability (generated).** Of the 2 templates this card bends, 2 have a filled example somewhere in this repository: [nfr](../../templates/definition/nfr.md) (9), [gtm-plan](../../templates/planning/gtm-plan.md) (1). No filled example in this repository was written for this domain; the examples above fill the same templates for other products. This paragraph is generated by `python3 tools/example_availability.py`.
