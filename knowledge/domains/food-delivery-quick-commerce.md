...
- **The EU's directive on platform work.** Pushes member states toward a rebuttable presumption of employment when a platform meets enough control indicators, and names algorithmic-management features, monitoring and automated decisions affecting working conditions, as relevant evidence (verify transposition and thresholds in your target member state).
