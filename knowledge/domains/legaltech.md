...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [personas](../../templates/discovery/personas.md) (1), [data-model](../../templates/architecture/data-model.md) (3), [integrations](../../templates/architecture/integrations.md) (2), [business-rules](../../templates/definition/business-rules.md) (6). Written for this domain: [domain-legaltech-data-model.md](../../examples/domain-legaltech-data-model.md). Filled examples of [personas](../../templates/discovery/personas.md), [integrations](../../templates/architecture/integrations.md), [business-rules](../../templates/definition/business-rules.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
