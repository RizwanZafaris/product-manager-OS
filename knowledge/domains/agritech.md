...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [problem-framing](../../templates/discovery/problem-framing.md) (2), [integrations](../../templates/architecture/integrations.md) (2), [personas](../../templates/discovery/personas.md) (1), [business-case](../../templates/planning/business-case.md) (2). Written for this domain: [domain-agritech-business-case.md](../../examples/domain-agritech-business-case.md). Filled examples of [problem-framing](../../templates/discovery/problem-framing.md), [integrations](../../templates/architecture/integrations.md), [personas](../../templates/discovery/personas.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
