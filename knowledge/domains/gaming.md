...
**Example availability (generated).** Of the 2 templates this card bends, 2 have a filled example somewhere in this repository: [release-readiness](../../templates/delivery/release-readiness.md) (3), [growth-plan](../../templates/planning/growth-plan.md) (1). Written for this domain: [domain-gaming-release-readiness.md](../../examples/domain-gaming-release-readiness.md). Filled examples of [growth-plan](../../templates/planning/growth-plan.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
