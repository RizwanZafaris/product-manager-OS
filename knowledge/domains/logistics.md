...
**Example availability (generated).** Of the 2 templates this card bends, 2 have a filled example somewhere in this repository: [failure-scenarios](../../templates/delivery/failure-scenarios.md) (6), [integrations](../../templates/architecture/integrations.md) (2). Written for this domain: [domain-logistics-failure-scenarios.md](../../examples/domain-logistics-failure-scenarios.md). Filled examples of [integrations](../../templates/architecture/integrations.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
