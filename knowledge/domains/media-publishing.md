...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [personas](../../templates/discovery/personas.md) (1), [business-rules](../../templates/definition/business-rules.md) (6), [integrations](../../templates/architecture/integrations.md) (2), [metrics-review](../../templates/operate/metrics-review.md) (2). Written for this domain: [domain-media-publishing-business-rules.md](../../examples/domain-media-publishing-business-rules.md). Filled examples of [personas](../../templates/discovery/personas.md), [integrations](../../templates/architecture/integrations.md), [metrics-review](../../templates/operate/metrics-review.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
