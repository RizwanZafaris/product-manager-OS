...
**Filled in this repo:** [expense-copilot-prd.md](../../examples/expense-copilot-prd.md), the closest fit in the repository: an expense-report copilot whose PRD names the AI overlay outright and holds the never-invent extraction rule (question 3), a guardrail metric separate from the eval threshold, and an explicit "would this be better without the model" cut of the multi-receipt feature (question 8). [expense-copilot-discovery.md](../../examples/expense-copilot-discovery.md) carries the honest baseline (62% first-submission approval before the model) that any eval or task-success claim in this domain has to beat. [ledgerline-north-star-tree.md](../../examples/ledgerline-north-star-tree.md) shows a metric tree input sourced explicitly to "eval set only" with an open field flagging that the live figure is still unknown, the exact discipline question 1 asks for. None of the three fills the AI-overlay documents themselves, so treat the PRD's citations as the nearest worked answer to what those documents should contain, not as a substitute for filling them. Which of this card's templates have filled examples, and which have none, is answered by the generated paragraph immediately below, which is regenerated from the declarations in the tree and checked rather than written by hand.

<!-- generated: example-availability -->
**Example availability (generated).** Of the 12 templates this card bends, 11 have a filled example somewhere in this repository: [agent-architecture](../../templates/ai/agent-architecture.md) (1), [ai-interaction-spec](../../templates/ai/ai-interaction-spec.md) (1), [context-management](../../templates/ai/context-management.md) (1), [eval-spec](../../templates/ai/eval-spec.md) (2), [guardrails](../../templates/ai/guardrails.md) (1), [hallucination-controls](../../templates/ai/hallucination-controls.md) (1), [human-approval-gates](../../templates/ai/human-approval-gates.md) (1), [model-card](../../templates/ai/model-card.md) (1), [multi-agent-workflow](../../templates/ai/multi-agent-workflow.md) (1), [prompt-structure](../../templates/ai/prompt-structure.md) (1), [red-team-review](../../templates/ai/red-team-review.md) (1). No filled example in this repository was written for this domain; the examples above fill the same templates for other products. No filled example of [assumptions-register](../../templates/definition/assumptions-register.md) exists anywhere in this repository. This paragraph is generated by `python3 tools/example_availability.py`.
