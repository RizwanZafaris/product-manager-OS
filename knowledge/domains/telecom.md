...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [integrations](../../templates/architecture/integrations.md) (2), [compliance-impact-assessment](../../templates/operate/compliance-impact-assessment.md) (3), [sla-slo-definition](../../templates/delivery/sla-slo-definition.md) (3), [nfr](../../templates/definition/nfr.md) (9). Written for this domain: [domain-telecom-nfr.md](../../examples/domain-telecom-nfr.md). Filled examples of [integrations](../../templates/architecture/integrations.md), [compliance-impact-assessment](../../templates/operate/compliance-impact-assessment.md), [sla-slo-definition](../../templates/delivery/sla-slo-definition.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
