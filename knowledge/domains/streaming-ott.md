...
**Example availability (generated).** Of the 2 templates this card bends, 2 have a filled example somewhere in this repository: [dependency-register](../../templates/execution/dependency-register.md) (3), [metrics-review](../../templates/operate/metrics-review.md) (2). Written for this domain: [domain-streaming-ott-dependency-register.md](../../examples/domain-streaming-ott-dependency-register.md). Filled examples of [metrics-review](../../templates/operate/metrics-review.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
