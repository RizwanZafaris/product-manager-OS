...
|---|---|---|
| [Ecommerce](ecommerce.md) | You sell or broker physical or digital goods for money per order, as a retailer, a brand, a wholesaler or a seller of age-restricted goods | Margin lives in a waterfall, not a percentage; the tax man arrives without a warehouse |
| [Streaming and OTT](streaming-ott.md) | You deliver licensed or original video or audio on subscription or ads, including music and its royalties | The content you rent defines what you can build; churn is the whole business |
| [Gaming](gaming.md) | You ship a game or game-like product with a session loop and no real-money wagering | Retention loops pay the bills; certification and loot-box law guard the door |
| [Sports betting and iGaming](sports-betting-igaming.md) | Players stake real money on a sporting or random outcome for a cash prize: a sportsbook, online casino, daily fantasy, lottery, or the B2B platform behind them. Pick this, not Gaming, whenever a cash prize can leave the product | The licence is per jurisdiction and the geofence decides whether a bet exists; handle can grow while net revenue shrinks |
...
| [Healthtech](healthtech.md) | Your product touches patients, clinicians, or health data, including consumer wellness and elder care | Intended use decides whether you built software or a medical device |
| [Edtech](edtech.md) | Your product teaches, and a school or district might pay for it, or you run software for childcare centres | Engagement is easy to show and efficacy is not; the district buys, the teacher decides |
| [Logistics](logistics.md) | You move physical things and promise when they arrive, by road, sea or rail | The last mile eats the margin; exceptions are the product |
...
| [Developer tools and APIs](devtools-api.md) | Your users write code or build pipelines and dashboards against you, and your interface is a contract | A breaking change is paid for by people who did not choose it; the deprecation notice is the product |
...
| [Marketplaces](marketplaces.md) | Two sides with opposed interests, and you take a cut of the match, including home services and care | Liquidity beats size; the better you match, the stronger the incentive to leave |
| [ERP and enterprise finance](erp.md) | Your product is the financial record, or the operations that feed it, including tax filing and climate disclosure | An auditor can refuse to sign because of how you store a change; the famous failures were cutovers, not defects |
...
| [Hardware and IoT](hardware-iot.md) | You ship a physical device with firmware, a fleet and an update path, including robots and chips | A bug is a recall; certification and the supply chain gate every launch |
| [Telecom](telecom.md) | You are a carrier or an MVNO, you build network products, or you sell messaging, voice or contact-centre platforms | Numbering, interconnect and lawful duties are the product's floor; billing is where trust is lost |
| [Public sector and govtech](public-sector-govtech.md) | Government buys, runs or mandates your product, or a charity or fundraiser runs on it | Procurement is the funnel; accessibility, records and identity are duties the buyer cannot waive |
| [Automotive and mobility](automotive-mobility.md) | Your software rides in a vehicle, or moves people and vehicles around a city, or you sell and finance vehicles through dealers | Functional safety and homologation decide the release date; the driver is a worker, a customer, or both |
...
| [Manufacturing and industrial](manufacturing-industrial.md) | Your software runs on or beside the plant floor, a mine, a well or a chemical plant | A change to a safety-rated system is a validated change; OT is not IT and the plant does not reboot |
| [Aerospace and defence](aerospace-defence.md) | You build for militaries, defence primes, aircraft, airline flight operations or space, where export control, security accreditation or airworthiness decide who may build it and where it may run | Who may see the code is a legal question; a change to certified software is a certification event |
...
| [Construction and AEC](construction-aec.md) | You build software to design, estimate, run or pay for construction projects, used by owners, general contractors, subcontractors, architects and engineers | The project is the customer and the contract is the data model; every record can become evidence in a claim |
| [Travel and hospitality](travel-hospitality.md) | You sell or run trips, rooms, seats or loyalty, or tickets to live events | Distribution is a negotiated channel; disruption handling and refunds are regulated promises |
| [Media and publishing](media-publishing.md) | You publish, subscribe, monetise or moderate content, including creator payouts and podcasts | The paywall and the ad stack pull in opposite directions; copyright and moderation duties never end |
...
| [Retail in store](retail-in-store.md) | You run the counter, the shelf, the inventory or the loyalty programme of a physical store, including a restaurant's till and kitchen display | The queue is the metric; a POS outage is a closed store |
