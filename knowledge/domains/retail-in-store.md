...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [integrations](../../templates/architecture/integrations.md) (2), [observability](../../templates/architecture/observability.md) (1), [release-readiness](../../templates/delivery/release-readiness.md) (3), [capacity-plan](../../templates/planning/capacity-plan.md) (1). No filled example in this repository was written for this domain; the examples above fill the same templates for other products. This paragraph is generated by `python3 tools/example_availability.py`.
