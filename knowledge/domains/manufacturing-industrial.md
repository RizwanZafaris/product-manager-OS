...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [security-architecture](../../templates/architecture/security-architecture.md) (1), [change-request](../../templates/execution/change-request.md) (1), [incident-postmortem](../../templates/operate/incident-postmortem.md) (1), [nfr](../../templates/definition/nfr.md) (9). Written for this domain: [domain-manufacturing-industrial-nfr.md](../../examples/domain-manufacturing-industrial-nfr.md). Filled examples of [security-architecture](../../templates/architecture/security-architecture.md), [change-request](../../templates/execution/change-request.md), [incident-postmortem](../../templates/operate/incident-postmortem.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
