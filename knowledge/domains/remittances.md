...
**Filled in this repo:** [domain-remittances-failure-scenarios.md](../../examples/domain-remittances-failure-scenarios.md) fills the [failure-scenarios](../../templates/delivery/failure-scenarios.md) template directly for this domain, for Tradewind Transfers: the FS-9 row on the PK-Lahore inbound corridor reporting zero agent float at 60% of locations, a correspondent bank de-risking the corridor, an FX rate lock expiring mid-transfer, a sanctions false positive holding a payout, and a receiver name mismatch at cash pick-up, where a stalled payout shows as 'processing', never 'failed', and the reroute owner sits in operations. For the other three bent templates, [sahulat-personas.md](../../examples/sahulat-personas.md) and [harbourgate-integrations.md](../../examples/harbourgate-integrations.md) remain the nearest reading for a cash-dependent user and a counterparty-SLA row, though neither carries a sender-receiver split across two licensed jurisdictions or a correspondent-bank row. [ledgerline-pricing-packaging.md](../../examples/ledgerline-pricing-packaging.md) is only near for a rejected-pricing-model comparison, since nothing filled in this repo prices a fee-plus-FX-spread product.

<!-- generated: example-availability -->
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [integrations](../../templates/architecture/integrations.md) (2), [personas](../../templates/discovery/personas.md) (1), [pricing-packaging](../../templates/planning/pricing-packaging.md) (1), [failure-scenarios](../../templates/delivery/failure-scenarios.md) (6). Written for this domain: [domain-remittances-failure-scenarios.md](../../examples/domain-remittances-failure-scenarios.md). Filled examples of [integrations](../../templates/architecture/integrations.md), [personas](../../templates/discovery/personas.md), [pricing-packaging](../../templates/planning/pricing-packaging.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
<!-- end generated: example-availability -->

**Worked example (ILLUSTRATIVE):** a slice of [failure-scenarios](../../templates/delivery/failure-scenarios.md) section 1, showing how this sector's payout side changes a scenario row. Names, corridor and numbers are fiction.

| ID | Scenario | Blast radius | Detection | Recovery | Data loss risk |
|---|---|---|---|---|---|
| FS-9 | Cash agent network in the PK-Lahore inbound corridor reports zero float at 60% of locations | Every receiver-side payout in that corridor stalls; senders still show "sent," receivers cannot collect | Agent liquidity feed drops below 40% coverage, alerted within 15 minutes (ILLUSTRATIVE) | Reroute new payouts to two backup agent networks with live float; hold affected transfers as "processing," never "failed"; owner: corridor operations lead, target 2 hours to reroute | None: funds are held at the sending entity, not lost, but unreachable to the receiver until rerouted |

A correspondent-bank exit needs its own row, not this one: it closes the corridor's licensed settlement path itself, and its owner is legal and licensing, not operations.
