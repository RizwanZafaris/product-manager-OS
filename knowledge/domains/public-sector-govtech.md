...
**Adjacent industries:** fundraising, donor-management and philanthropy platforms read this card for the grant-cycle buyer, with charity regulators and state charitable-solicitation registration as gatekeepers, tax rules on donation receipts (UK Gift Aid, US deductibility acknowledgements) and fundraising-specific consent guidance under GDPR-style regimes. Restricted-fund accounting reads [ERP and enterprise finance](erp.md), and a crowdfunding product that holds money between parties reads [Embedded finance and BaaS](embedded-finance-baas.md). Defence buyers read [Aerospace and defence](aerospace-defence.md) instead: export control, security accreditation and air-gapped deployment change the procurement funnel this card describes. As of 2026-09-11; verify and confirm with counsel.
...
**Filled in this repo:** [domain-public-sector-govtech-release-readiness.md](../../examples/domain-public-sector-govtech-release-readiness.md) fills the [release-readiness](../../templates/delivery/release-readiness.md) template directly for this domain, for Renew, a national benefits-renewal service: accessibility tested with assistive-technology users to WCAG 2.2 AA where a failed test blocks launch outright, the assisted phone channel's capacity as its own go or no-go row, an identity-proofing failure fallback, a records-retention and freedom-of-information check, a plain-language reading-age check, and a phased regional rollout, signed by the senior responsible owner and the service assessment panel by role. For the other three bent templates, [harbourgate-stakeholder-map.md](../../examples/harbourgate-stakeholder-map.md) remains the nearest reading, for how interest and influence are scored with a named RACI role. accessibility-checklist and privacy-impact-assessment have no filled example in the repository yet for this domain.

<!-- generated: example-availability -->
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [accessibility-checklist](../../templates/architecture/accessibility-checklist.md) (1), [privacy-impact-assessment](../../templates/architecture/privacy-impact-assessment.md) (1), [stakeholder-map](../../templates/execution/stakeholder-map.md) (1), [release-readiness](../../templates/delivery/release-readiness.md) (3). Written for this domain: [domain-public-sector-govtech-release-readiness.md](../../examples/domain-public-sector-govtech-release-readiness.md). Filled examples of [accessibility-checklist](../../templates/architecture/accessibility-checklist.md), [privacy-impact-assessment](../../templates/architecture/privacy-impact-assessment.md), [stakeholder-map](../../templates/execution/stakeholder-map.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
<!-- end generated: example-availability -->

**Worked example (ILLUSTRATIVE):** a slice of [release-readiness](../../templates/delivery/release-readiness.md) for a fictional national benefits-renewal service, Renew, run by a fictional agency, the Directorate of Social Support. Every name, number, and date is invented.

| Gate row | Evidence | Status | Owner |
|---|---|---|---|
| Accessibility: WCAG 2.1 AA tested with a screen reader, not only an automated scanner | Manual session with two screen-reader users, 2026-08-14: 6 of 8 tasks completed; two blocking findings on the payment-confirmation step | NO-GO until the two findings are fixed and retested | [OPEN: name], Accessibility lead |
| Assisted channel staffed for launch week | Phone-line capacity confirmed for 3x normal call volume, 2026-08-20 to 2026-08-27 | GO | [OPEN: name], Service delivery lead |
| Freedom-of-information readiness: can this system produce and redact its own records on the statutory clock | Records export tested against a sample request; redaction confirmed for three of four protected fields, 2026-08-10 | GO WITH CONDITIONS: caseworker notes field untested | [OPEN: name], Records officer |
| Peak-day failure plan: renewal deadline day | Load test to 4x average traffic, 2026-08-18, held at p95 under 2 seconds; no failover rehearsal held yet | NO-GO pending failover rehearsal | [OPEN: name], Engineering lead |
