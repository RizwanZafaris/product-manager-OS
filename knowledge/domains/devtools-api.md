...
**Filled in this repo:** [domain-devtools-api-nfr.md](../../examples/domain-devtools-api-nfr.md) fills the [nfr](../../templates/definition/nfr.md) template directly for this domain, for Lanternfish API: a 12-month deprecation window on /v1/orders with the preview endpoint excluded, 50 requests per second per key with 429 and Retry-After plus an enterprise burst allowance, changelog and notice lead time, SDK support window, idempotency-key retention, sandbox parity, a status-page SLA, and a rule that lowering a rate limit or shortening a window is itself a breaking change, verified by the API platform lead and the developer-relations lead. For the other three bent templates, [harbourgate-api-contract.md](../../examples/harbourgate-api-contract.md) and [harbourgate-migration-cutover-plan.md](../../examples/harbourgate-migration-cutover-plan.md) remain the nearest reading, for versioning and rate-limit mechanics and a phased cohort cutover, though Quay is an internal payments API for one company's own checkout, not an open developer platform. No filled sla-slo-definition example in this repository was written for an open developer platform; [harbourgate-sla-slo-definition.md](../../examples/harbourgate-sla-slo-definition.md) is the nearest reading, for a payment service rather than a public API. A public-facing deprecation notice has no template here and no example.

<!-- generated: example-availability -->
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [api-contract](../../templates/architecture/api-contract.md) (2), [nfr](../../templates/definition/nfr.md) (9), [sla-slo-definition](../../templates/delivery/sla-slo-definition.md) (3), [migration-cutover-plan](../../templates/delivery/migration-cutover-plan.md) (1). Written for this domain: [domain-devtools-api-nfr.md](../../examples/domain-devtools-api-nfr.md). Filled examples of [api-contract](../../templates/architecture/api-contract.md), [sla-slo-definition](../../templates/delivery/sla-slo-definition.md), [migration-cutover-plan](../../templates/delivery/migration-cutover-plan.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
