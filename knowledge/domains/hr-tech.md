...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [prd](../../templates/definition/prd.md) (1), [eval-spec](../../templates/ai/eval-spec.md) (2), [human-approval-gates](../../templates/ai/human-approval-gates.md) (1), [release-readiness](../../templates/delivery/release-readiness.md) (3). Written for this domain: [domain-hr-tech-eval-spec.md](../../examples/domain-hr-tech-eval-spec.md). Filled examples of [prd](../../templates/definition/prd.md), [human-approval-gates](../../templates/ai/human-approval-gates.md), [release-readiness](../../templates/delivery/release-readiness.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
