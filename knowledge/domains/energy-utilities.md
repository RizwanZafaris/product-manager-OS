...
**Example availability (generated).** Of the 4 templates this card bends, 4 have a filled example somewhere in this repository: [integrations](../../templates/architecture/integrations.md) (2), [sla-slo-definition](../../templates/delivery/sla-slo-definition.md) (3), [compliance-impact-assessment](../../templates/operate/compliance-impact-assessment.md) (3), [risk-register](../../templates/execution/risk-register.md) (6). Written for this domain: [domain-energy-utilities-sla-slo-definition.md](../../examples/domain-energy-utilities-sla-slo-definition.md). Filled examples of [integrations](../../templates/architecture/integrations.md), [compliance-impact-assessment](../../templates/operate/compliance-impact-assessment.md), [risk-register](../../templates/execution/risk-register.md) exist, but none was written for this domain. This paragraph is generated by `python3 tools/example_availability.py`.
