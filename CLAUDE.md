...
| "learn", "teach me", "quiz me", "study", or practice on a fictional product | [learn/skills/tutor/SKILL.md](learn/skills/tutor/SKILL.md); paths and workspace convention in [learn/INDEX.md](learn/INDEX.md) | The path files in `learn/`, practice artifacts in `learn/products/<name>/` |
| "Which domain", "domain pack", or what changes for a specific market | No skill. Read [knowledge/domains/INDEX.md](knowledge/domains/INDEX.md) and open the named card | The card's Templates-this-bends line |
| "What does a <title> do", ladder, leveling, PM vs PMM, or role-scope questions | No skill. Read [knowledge/roles/INDEX.md](knowledge/roles/INDEX.md) and the card it routes to | `templates/planning/first-90-days.md`, `templates/execution/stakeholder-map.md` |
