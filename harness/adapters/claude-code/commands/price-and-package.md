...
description: "Router row: Pricing, packaging, tiers, or willingness to pay. No stage and no gate, judgment tier. Say: pricing; packaging; tiers; willingness to pay."
disable-model-invocation: true
---

GENERATED FILE. Do not hand-edit. Written by `harness/adapters/claude-code/generate.py` from `harness/MANIFEST.json`; edit the manifest, then regenerate.

# Route: price-and-package

| Field | Value |
|---|---|
| Route id | `price-and-package` |
| Router row | Pricing, packaging, tiers, or willingness to pay |
...
| Skill | `skills/pricing-packaging/SKILL.md` |
...
2. Follow `skills/pricing-packaging/SKILL.md` end to end. It owns the workflow; this file only routes to it.
...
- `frameworks/pricing/packaging-good-better-best.md`

## Templates the output lands in

- `templates/planning/pricing-packaging.md`
