---
name: pick-domain-pack
description: "Router row: \"Which domain\", \"domain pack\", or what changes for a specific market. No stage and no gate, extraction tier. Say: which domain; domain pack; what changes for this market."
disable-model-invocation: true
---

GENERATED FILE. Do not hand-edit. Written by `harness/adapters/claude-code/generate.py` from `harness/MANIFEST.json`; edit the manifest, then regenerate.

# Route: pick-domain-pack

| Field | Value |
|---|---|
| Route id | `pick-domain-pack` |
| Router row | "Which domain", "domain pack", or what changes for a specific market |
...
No skill: read the index, open the named card, and follow the card's own Templates-this-bends line. The selected domain, or the recorded none, lands in STATE.md at Gate 1.
