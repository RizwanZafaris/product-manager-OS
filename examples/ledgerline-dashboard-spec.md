...
**Owner:** Maya Chen, product manager · **Builder:** Kwame Boateng, data analyst · **Audience:** the add-on launch team (product, engineering, marketing, sales and finance leads named in the journey cast) · **Tool:** [OPEN: the BI tool is not named in the data sheet; confirm with Kwame Boateng before build] · **Date:** 2026-11-06 · **Status:** Verified (verification passes 2026-11-13, 2026-12-19 and 2026-12-22, section 7)
**Last updated:** 2026-12-22, after the EXP-1 kill (2026-12-18) and the metrics dictionary's two change log entries (2026-12-19, M-007 window; 2026-12-22, S-2 scope correction); the body below is the spec as it stood at its 2026-11-06 sign-off, with later facts this update adds marked by date where that separates sign-off knowledge from hindsight
**Dictionary version:** 2026-12-22, the date of the later of the metrics dictionary's two change log entries (2026-12-19, M-007 window; 2026-12-22, S-2 scope correction), on [ledgerline-metrics-dictionary.md](ledgerline-metrics-dictionary.md), agreed by Maya Chen and Kwame Boateng on 2026-11-04 and re-reviewed by the same two on 2026-12-19 and again on 2026-12-22
...
The tile unlocks for the full launch team once the 2026-12-18 analysis is logged. The number the team sees at unlock is the ratified result: 73 of 2,748 exposed, 2.7% pooled, under the 4.0% kill line (N61). The metrics dictionary's first of its two change log entries, posted 2026-12-19, clarified the window's precision (336 hours, 14 x 24, UTC from min(exposure_event.timestamp) per account) after this value was already computed against that same exposure-based window; it is a precision clarification, not a redefinition, and changed no ratified value (dictionary, section 6). The restriction held in practice: the OKR sheet's 2026-12-14 check-in entry records that M-007 was not read and that the funnel tile stayed restricted to the analyst until the 2026-12-18 analysis date ([ledgerline-okrs.md](ledgerline-okrs.md)).
...
Reproduced by hand from the dictionary formulas on 2026-12-19, the day after the add-on review window closed (2026-11-23 to 2026-12-18, N63) and the day the metrics dictionary's first change log entry (of the two now on record: 2026-12-19, M-007 window; 2026-12-22, S-2 scope correction) landed on M-007's window definition, triggering the template's rule to re-verify after any dictionary change log entry. This pass covers all twelve tiles, both closing the eight left open at pass 1 and reconfirming T-7 against the clarified window wording (no ratified value changed).
...
### Pass 3: after the 2026-12-22 dictionary change log entry

Reproduced by hand on 2026-12-22, the day the metrics dictionary's second change log entry corrected segment S-2's "Applies to metric ids" cell to add M-001, M-008 and M-011, matching this spec's own S-2-scoped tiles (T-1, T-8, T-11) and pass 1's T-8 and T-11 rows, which were already scoped to S-2. This pass re-verifies only the three tiles the correction touches; the other nine were unaffected by a segment-scope correction and are not re-run.

| Tile | Dictionary value on 2026-12-22, S-2 scope | Dashboard value | Match (yes / no) | Explanation if no |
|---|---|---|---|---|
| T-1 (M-001) | S-2 (the six design partners) included in scope per the corrected segment table; no change to the tile's own formula or measured value | S-2 already selectable as a segment filter on T-1 (section 3) | Yes | The correction only made explicit what the tile already offered; no value changed |
| T-8 (M-008) | S-2 included in scope per the corrected segment table; no change to the tile's own formula or measured value | S-2 already selectable as a segment filter on T-8 (section 3) | Yes | The correction only made explicit what the tile already offered; no value changed |
| T-11 (M-011) | S-2 included in scope per the corrected segment table; no change to the tile's own formula or measured value | S-2 already selectable as a segment filter on T-11 (section 3) | Yes | The correction only made explicit what the tile already offered; no value changed |

No value changed on any of the three tiles; the correction brought the dictionary's segment table into agreement with what this spec and pass 1 already had.
...
- [x] Signed by Maya Chen, product manager, 2026-11-13; re-verified and this update signed 2026-12-22

Approved 2026-11-06, the session that also approved the GTM plan and the one-pager; verified and originally signed 2026-11-13; re-verified and this update signed: Maya Chen, product manager, 2026-12-22
