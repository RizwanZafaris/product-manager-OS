...
| T-7 | Q2 | M-007 | funnel (exposed, opened, reached price step, paid) | weekly, analyst-only, through the exposure window, per the dictionary; the single ratified value is read once, ad hoc, at the pre-declared analysis date (2026-12-18) | ship line 6.0%, iterate band 4.0% to 6.0%, kill line under 4.0% (N57) | S-3, S-4 | Kwame Boateng, access-restricted, see below |
...
| T-9 | Q3 | M-009 | number | weekly estimate, published same day; trued up monthly against the vendor invoice, up to 30 days behind, per the dictionary | ceiling $1.05 per drafted report (N74) | none | Daniel Okafor |
...
| T-7 (M-007) | Weekly, analyst-only, through the exposure window; one ad hoc ratified read at the experiment's analysis date | as of the 2026-12-18 analysis, analyst-only until then | none found on 2026-11-04; the window definition's precision was clarified 2026-12-19 (dictionary section 6 change log; no ratified value changed), so this spec's own re-verification (section 7) reconfirms T-7 against the clarified wording |
...
|---|---|---|---|---|
| T-1 (M-001) | 422 drafted reports approved first time, window 2026-11-23 to 2026-12-18 (N65); reported under the M-001 id as a window count, not the calendar-month value M-001's own definition produces | 422 (read off the dashboard tile) | Yes | |
...
| T-7 (M-007) | 73 of 2,748 exposed, 2.7% pooled; 33 of 1,371, 2.4% control; 40 of 1,377, 2.9% anchored (N61). The window's precision was clarified 2026-12-19 (336 hours from min(exposure_event) per account, dictionary section 6); no value changed | 2.7% pooled (read off the dashboard tile), reconfirmed against the clarified window wording before the 2026-12-18 unlock | Yes | |
| T-8 (M-008) | 2.4 errors per 100 drafted reports, window (N67) | 2.4 per 100 (read off the dashboard tile) | Yes | |
| T-9 (M-009) | $0.93 model cost per drafted report, weekly-estimate reading, window (N67) | $0.93, weekly-estimate reading (read off the dashboard tile) | Yes | |
| T-10 (M-010) | 5.1 support tickets per 100 add-on accounts per week, window (N67) | 5.1 per 100 (read off the dashboard tile) | Yes | |
| T-11 (M-011) | $15,900 (73 paid accounts, 2,480 seats x $6 = $14,880, plus 6 partners, 228 seats x $6 x 0.75 = $1,026) at 2026-12-18 (N68) | $15,900 (read off the dashboard tile) | Yes | |
| T-12 (M-012) | 36% (422 of 1,180 eligible reports), window 2026-11-23 to 2026-12-18 (N65); reported under the M-012 id as a window count, not the calendar-month value M-012's own definition produces | 36% (read off the dashboard tile) | Yes | |
