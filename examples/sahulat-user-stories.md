...
**Feature:** Sahulat Bill Pay, paying an electricity or gas bill from the wallet with cash-in through the agent network · **PRD:** [sahulat-one-pager.md](sahulat-one-pager.md), the artifact weight D2 chose over the BRD or FRD stack · **Owner:** Hira Baig, Product Manager, the only PM in the company · **Personas:** sahulat-personas.md · **First written:** 2026-03-11 · **Last refined:** 2026-05-21, the day D5 killed SAHULAT-S7 · **Status:** SIGNED at Gate 2 attempt 2, 2026-03-25; the affected criterion re-signed against Gate 2 on 2026-05-21 per D5, recorded in sahulat-decision-log.md

## 1. The slice this release ships

**Walking skeleton (the thinnest end-to-end path):** Shazia looks up her Ravi Power bill by the reference number printed on it, over USSD, pays it from her wallet balance, and receives an SMS with a payment reference: the thinnest working path through EP1, and the first two rows of the story register below.

| Release | What a user can do afterwards that they could not before | Stories included |
|---|---|---|
| R1 (Rel-1) | Shazia can look up and pay a Ravi Power or Chenab Gas bill, either from a wallet balance she already holds or from cash she hands an agent in the same visit, get an SMS she can show as proof, recover safely if her USSD session drops mid-payment, and reach a support agent who can answer "did it go through" on the first call. | SAHULAT-S1, S2, S3, S5, S6, S8, S9, S10, S11 |
| Rel-2 | Rafiq sees a confirmation on his own agent handset for a bill payment he enabled, so he can vouch for it without a call to Naveed's helpline; a Mehran Water bill can be paid the same way, once a story replaces the one D5 killed. | SAHULAT-S4; a water story to replace SAHULAT-S7, no id assigned yet. Open: Hira Baig, gated on a validated Mehran Water reference feed |
| Later | Nothing is scheduled past Rel-2 as of this refinement. | None |

## 2. Epics

The one-pager states a single objective, O1: a bill due in the household is paid through Sahulat before its due date, and no late surcharge is paid that month, the Gate 1 outcome signal from attempt 2, 2026-02-27, carried in unchanged. Every story below serves it; the epics just group the paths to it (EP1 to EP3 in the data sheet). EP2 answers the question the [mobile money and wallets](../knowledge/domains/mobile-money-wallets.md) card asks about the agent's cash float being as much a part of uptime as a server log; EP3 answers the question the [payments acquiring](../knowledge/domains/payments-acquiring.md) card asks better than any other, what happens when a payment is approved and fulfilment fails afterward, carried here as AC-9 and risk R3.

| Epic | Objective it serves (from [sahulat-one-pager.md](sahulat-one-pager.md)) | Stories | Status |
|---|---|---|---|
| EP1: Look up and pay a bill | O1, the direct path: look up, pay, hold proof | SAHULAT-S1, S2, S5, S6, S10, S11; SAHULAT-S7 killed, see section 3 | In BUILD. S1, S2, S6 are Rel-1 musts; S5, S10, S11 are Rel-1 shoulds |
| EP2: The agent counter | O1, and answers the cost of inaction the second trip prices: a customer who cashes in and pays in one visit makes no second trip (N20, N21 in the journey data sheet, ILLUSTRATIVE) | SAHULAT-S3, S4 | S3 in BUILD for Rel-1; S4 not started, Rel-2 |
...
| SAHULAT-S4 | As Rafiq, I want to see a confirmation on my agent handset when a customer I cashed in pays a bill, so that I can vouch for it when asked. | Rafiq (P2) | should, Rel-2 | None drafted, see Open questions row 5 | Open: Zainab Qureshi | Not started | No confirmation view for Rafiq today; a bill he enabled is invisible to him unless the customer says so (E3) |
| SAHULAT-S5 | As Shazia, I want to save a reference after paying, so that next month I do not re-enter it. | Shazia (P1) | should, Rel-1 | None drafted, see Open questions row 2 | Open: Zainab Qureshi | In BUILD | Balance-first slice with S10, S11 (N54, ILLUSTRATIVE: 9 of 28 engineer-weeks). Also serves P3, Kamran, ASSUMPTION at Gate 1, on two sessions only |
...
| SAHULAT-S8 | As Shazia, I want a session that drops mid-payment to tell me whether money moved, so that I do not pay twice. | Shazia (P1) | must, Rel-1 | AC-7, AC-8, AC-10 | Open: Zainab Qureshi | In BUILD, resume half flagged, see section 4 | From E4, the dropped-session line in INT-007; ADR-2's idempotency key is the report-half mechanism |
| SAHULAT-S9 | As a support agent on Naveed's team, I want to look up a bill payment by reference, so that I answer "did it go through" on the first call. | Naveed Akhtar's support team, not P1, P2 or P3, see the exit gate below | should, Rel-1 | AC-11 | Open: Zainab Qureshi | Not started | No formal persona exists for the support desk today |
| SAHULAT-S10 | As Shazia on the app, I want the same lookup and pay flow, so that I am not forced onto USSD. | Shazia (P1) | should, Rel-1 | Inherits AC-1 to AC-5 by interface parity, not independently drafted, see Open questions row 1 | Open: Zainab Qureshi | Not started | Balance-first slice (N54); Interface pattern (section 5), USSD before the app |
| SAHULAT-S11 | As Shazia, I want an SMS three days before a saved bill's due date, so that I cash in before the surcharge. | Shazia (P1) | should, Rel-1 | AC-12 | Open: Zainab Qureshi | Not started | Balance-first slice (N54); depends on S5's saved reference, a designed dependency like S2 on S1 |

Estimate: this squad does not point stories. BUILD capacity is tracked as engineer-weeks against the sprint log (N8, ILLUSTRATIVE: 4 engineers times 7 weeks equals 28 engineer-weeks), not per story, so every Estimate cell above reads Open: Zainab Qureshi, the engineering lead.

**Killed or superseded stories.** Never delete a row; move it here so the id stays spent.

| ID | Story | Why it is dead | Superseded by |
|---|---|---|---|
| SAHULAT-S7 | As Shazia, I want to pay a Mehran Water bill the same way (must at Gate 2). | Killed by D5, 2026-05-21: 3 of 10 Mehran Water test bills failed reference validation (N58, ILLUSTRATIVE, measured, 2026-05-19). Fixing the feed before the Rel-1 date would have pushed Gate 4, so the story was dropped and the date was not. | Open: Hira Baig, no replacement id assigned yet; the open Rel-2 candidate named in section 1, gated on BillBridge or Mehran Water fixing the feed |
...
Run on the five Rel-1 musts at Gate 2 attempt 2 (2026-03-25) and re-run here on 2026-05-21 after D5. Verdicts recorded, not assumed.
...
| SAHULAT-S2 | Designed dependency on S1, ships with it in R1 | Pass | Pass: holds an SMS reference before the due date | Pass | Pass: pay-and-confirm is one slice; drop cases live in S8 | Pass: AC-3, AC-4, AC-9, AC-10, AC-13 | PASS |
| SAHULAT-S3 | Pass | Pass | Pass: no second trip (N20, N21) | Pass | Pass | Pass: AC-5 | PASS |
| SAHULAT-S6 | Pass: reuses S1 and S2's mechanism | Pass | Pass: one channel for both monthly bills | Pass | Pass: Data variation pattern, gas after electricity | Pass: AC-6 | PASS |
| SAHULAT-S8 | Designed dependency on S2, same shape as S2 on S1 | Pass | Pass: does not pay twice | Partial: the report half is sized against ADR-2's idempotency key; the resume half, continuing the debit on the next dial after a session drops before it posts, is not separately estimated. Open: Zainab Qureshi, before Gate 4, 2026-06-10 | At risk: an oversized resume-half estimate splits this must into a report-only Rel-1 slice and a resume Rel-2 slice. Not yet decided | Pass: AC-7, AC-8 each name a failing case; AC-10 blocks the duplicate | PASS, with an open E/S risk on the resume half. See the exit gate below |
...
No Rel-1 story needed splitting this refinement; every must in section 3 is already one vertical slice. One split was considered and rejected: SAHULAT-S2's "pay the bill" and "get an SMS with a reference" could split along Happy path first, but pulling the SMS out ships a debit with no confirmation Shazia can see, exactly the state AC-7 and AC-8 exist to catch, so the two stayed together. SAHULAT-S6 already shows Data variation applied once, gas after electricity; SAHULAT-S7 was its second application until D5 removed it, and the water story that replaces it will reuse the pattern rather than invent one. SAHULAT-S10 shows the Interface pattern: USSD ships in Rel-1 before the app.
...
| SAHULAT-S8 | O1 | None (D2) | AC-7, AC-8, AC-10 | Open: Mariam Gill |
...
- Objectives with no story: none. O1 is the one-pager's only objective at this artifact weight, and every must and should above serves it.
...
| 3 | Does SAHULAT-S9 get a named persona for Naveed's support desk in sahulat-personas.md, or is it re-attributed to an existing one | SAHULAT-S9 | Hira Baig | Open: Hira Baig |
| 4 | Does a Mehran Water replacement for SAHULAT-S7 get a story id in this release or the next, once BillBridge or Mehran Water fixes the reference feed N58 found unreliable | Rel-2 scope, section 1 | Hira Baig, with Zainab Qureshi confirming feasibility | Open: Hira Baig |
| 5 | Does SAHULAT-S4's agent-handset confirmation need its own acceptance criteria before Rel-2 planning starts, since none of AC-1 to AC-13 covers an agent-side view | SAHULAT-S4 | Hira Baig | Open: Hira Baig, before Rel-2 kickoff |

## Exit gate (feeds Gate 2: requirements signed off)

Gate 2 was signed by Hira Baig and Faisal Mirza on 2026-03-25, attempt 2, in `gates/gate-2-attempt-2.md`. D5 on 2026-05-21 sent the affected criterion back through Gate 2 rather than absorbing the change, and the checklist below is walked again here to answer whether the amended register still meets it, not to declare the gate passed a second time; that record belongs to the gate file and the two names on it.

- [x] Every must-priority story has an acceptance criteria id that could fail
- [ ] Every story names a persona that exists in sahulat-personas.md: SAHULAT-S9 names "a support agent on Naveed's team," who is not P1, P2 or P3. See Open questions, row 3.
- [x] Every story states an outcome, not a screen and not a technology
- [x] INVEST has been run on every must, and the verdicts are recorded rather than assumed (section 4)
- [ ] No story in this release is too big to finish in one iteration, or it has been split and both halves re-checked: SAHULAT-S8's resume half, a session that drops before the debit posts, has not been estimated separately from its report half. See section 4, Estimable and Small.
- [x] The walking skeleton is named and R1 delivers it end to end
