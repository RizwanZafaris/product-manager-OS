...
| KR4 | Add-on monthly recurring revenue, dollars (M-011) | $0 (N73) | $30,000 (N73) | $15,906, at 2026-12-18 (N68, N73) | 0.53 (N73) | Maya Chen (P1) |
...
|---|---|---|---|
| 2026-11-16 | KR1 at 6 of 180, the six design partners live since 2026-11-10 (N41); KR4 not yet billed: add-on seat metering (DEP1) committed for 2026-11-19, needed by 2026-11-20, not yet delivered; the design-partner line comes to $1,026 once billed, $6 per seat with the 25% partner discount across 228 seats (N41, N68 partner component); KR2 and KR3: the phase 1 window (2026-11-10 to 2026-11-22, N43) is still open, too early for a rate | Confidence on KR1 and KR4 unchanged, six design partners live is the expected phase 1 state and EXP-1 had not opened; confidence on KR2 and KR3 unchanged, no rate yet to raise or lower it against | R2 opened the same day: seat metering cannot bill the 214 legacy annual-invoice accounts mid-term; owner Priya Nair with the billing lead |
| 2026-11-30 | EXP-1 exposure at 1,885 of 2,900 accounts (N81); DEP1 delivered 2026-11-19 with the R2 gap (seat metering cannot bill the 214 legacy annual-invoice accounts mid-term); KR1 and KR4 not restated in this log, though T-3 and T-11 refresh daily on the dashboard; KR2 and KR3 not re-pulled either, both weekly tiles; R4 escalated, the customer DPA blocking two Enterprise deals | Confidence on KR1 and KR4 unchanged: no KR1 or KR4 reading is logged in this entry, and R4 cannot bear on either, since Enterprise (S-6) is out of scope for M-002 and M-011 by definition (metrics dictionary section 1; dashboard spec section 6, T-11 row); confidence on KR2 and KR3 also unchanged, no rate re-pulled this week either. The status report for this week reads AMBER overall with one RED (R4), on grounds separate from these two KRs | R4 escalated to Isabel Ferreira; R2 remains open with the billing lead; no KR target edited |
...
[OPEN: the 2026-11-30 and 2026-12-14 rows above record no dated KR1, KR2, KR3 or KR4 reading for M-002, M-003, M-006 or M-011 on 2026-11-29 or 2026-12-13; the journey data sheet's N-ids only give the single 2026-12-18 reading for each (N64, N65, N68). Pulling a T-3, T-4, T-2 or T-11 value for those two dates would require a new dated data-sheet entry, which this pass does not invent per the no-fabrication rule; owner Maya Chen, next check-in cadence review]
