...
| 3 | DEFINE, Gate 2 | [templates/planning/vision.md](../templates/planning/vision.md) | [expense-copilot-vision.md](expense-copilot-vision.md) | The destination and who it serves; approved by Daniel Okafor as business sponsor. Uses V3, V8. |
| 4 | DEFINE, Gate 2 | [templates/planning/product-strategy.md](../templates/planning/product-strategy.md) | [expense-copilot-product-strategy.md](expense-copilot-product-strategy.md) | Where to play, how to win, and what v1 will not do, tracing to the PRD's own Out of scope list. Uses V4, V8, V17. |
| 5 | DEFINE, Gate 2 | [templates/planning/roadmap.md](../templates/planning/roadmap.md) | [expense-copilot-roadmap.md](expense-copilot-roadmap.md) | Phases ordered toward the PRD's three objectives, each with a success measure. Uses V5, V8; N16. |
...
| 7 | DEFINE, Gate 2 | [templates/definition/acceptance-criteria.md](../templates/definition/acceptance-criteria.md) | [expense-copilot-acceptance-criteria.md](expense-copilot-acceptance-criteria.md) | AC-1 to AC-10, each verifying one REQ id, with edge and negative coverage. Uses V7, V17, V18. |
| 8 | DESIGN, Gate 3 | [templates/architecture/adr.md](../templates/architecture/adr.md) | [expense-copilot-adr.md](expense-copilot-adr.md) | ADR-0001, the receipt-pipeline decision, its rejected option and its consequence. Uses V9. |
| 9 | DESIGN, Gate 3 | [templates/architecture/data-model.md](../templates/architecture/data-model.md) | [expense-copilot-data-model.md](expense-copilot-data-model.md) | The five entities, their relationships and their provisional PII flags. Uses V10. |
| 10 | DESIGN, Gate 3 | [templates/architecture/api-contract.md](../templates/architecture/api-contract.md) | [expense-copilot-api-contract.md](expense-copilot-api-contract.md) | The six resources, one set per REQ id that needs an endpoint, with idempotency on the submit call. Uses V11, V17. |
| 11 | all stages, read at Gate 3 | [templates/execution/decision-log.md](../templates/execution/decision-log.md) | [expense-copilot-decision-log.md](expense-copilot-decision-log.md) | D-1 to D-6 in full, index and entries, none reversing another. Uses V12 and the Decision log table above. |
| 12 | DESIGN, Gate 3 | [templates/execution/dependency-register.md](../templates/execution/dependency-register.md) | [expense-copilot-dependency-register.md](expense-copilot-dependency-register.md) | DEPV-1 to DEPV-4, each with an owner, a needed-by date and an escalation path. Uses V13 and the Dependencies table above. |
| 13 | DESIGN, Gate 3 | [templates/execution/risk-register.md](../templates/execution/risk-register.md) | [expense-copilot-risk-register.md](expense-copilot-risk-register.md) | RV-1 to RV-4, scored from the 2026-09-08 premortem. Uses V14 and the Risks table above. |
| 14 | DESIGN exit, Gate 3 | [templates/architecture/development-handoff.md](../templates/architecture/development-handoff.md) | [expense-copilot-development-handoff.md](expense-copilot-development-handoff.md) | Links all thirteen other artifacts across its nine sections, with no `Gap:` line, and names Gates 1 to 3 as fictional sign-offs. Uses V15, V2, V8, V16. |
