...
- Kestrel's terminal SDK supports the kiosk PIN pad model, pending certification (certification pending; tracked as DEP-1 from 2026-04-10), and the kiosk firmware also needs updating across all 61 shops (R12). Until both land, Tidewater's wrapper, the component nobody could name an owner for, cannot be retired.
...
- 2026-08-24: D-022 records Rohan Iyer accepting R4 by name, alongside the kiosk fallback (N31), the peak change freeze (N64) and a review on 2027-01-31, then quarterly.
