...
- Feature requests from prospects: write an evidence note that feeds the regular feedback-synthesis pass ([feedback-program.md](ledgerline-feedback-program.md) owns the intake). **(added 2026-11-10, when the advisory board was chartered)** The Ledgerline Expenses Advisory Board, chartered in feedback-program.md section 5 with Hana Sato as owner, informs the pricing and packaging review and Gate 5 go calls through its own paying-account panel; it is not the intake for a prospect's feature request
