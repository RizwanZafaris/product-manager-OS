...
|---|---|---|---|---|---|---|
| A1 | Build ADR-0004: reconcile settlement for both paths from one ledger, matching on either reference, with a classified straddle set for lines that cross the cutover | 1 | Bea Lindqvist | 2026-07-03 | Rehearsal 2 passing AC-8 | verified |
...
| A6 | A dependency sitting at "requested" for more than 4 weeks is escalated automatically at the weekly dependency review | 2 | Ife Adeyemi | 2026-06-19 | Confirmed against the dependency register's own review log from 2026-06-19 onward | verified |
...
All six actions verified before the first Marlowe cohort shipped under the reshaped plan. Cutover plan v2 carries A3 through N72 in its phase 0 pre-checks, A1 through ADR-0004 in section 5 (reconciliation), A5 in section 4 (the abort rule) and A2 in section 3 (the rehearsal gaps); A4 and A6 do not appear there.
