...
**Owner:** Hira Baig, Product Manager, the only PM · **Horizon:** 3 years (2026 to 2029) · **Last updated:** 2026-08-28 · **Status:** Signed 2026-03-02 by Faisal Mirza; amended 2026-08-28 after decision D8. D3 (2026-04-03), ADR-2 (2026-04-09) and D8 (2026-08-28) postdate the original sign-off and are folded in at this amendment
...
None of that arithmetic is visible to her now. She never wonders whether a session that dropped mid-payment took her money; if one does, a message tells her within two minutes whether the money moved, before she thinks to dial again (E4). She pays whichever way she has money that week, sometimes from a balance already sitting in the phone, more often from cash just handed to Rafiq, and the bill is paid before its due date either way. The paper bill still arrives in the post and sits in a drawer with the others; nothing on it matters to her anymore, because the reference, the amount and the receipt all live in a text message she can find any time.
...
| Field | Answer |
|---|---|
| Primary customer | Shazia, the household bill-runner (persona P1): a composite of six of the fourteen discovery sessions (INT-001, 002, 004, 005, 007, 008), who already reaches Sahulat through an agent or a USSD short code, and who pays her household's electricity and gas bills, and sometimes water (N22) |
...
| Falak Telecom's own USSD tariff rises in October, raising the cost of every session and every retry on the channel most of Sahulat's base actually uses, and bill pay is more session-heavy than a routine cash-in: a bill lookup, a payment confirmation and, when a session drops, a status check and a retry are each their own session against the same 180-second gateway ceiling (N56, N66), a pattern discovery already saw as a repeat attempt rather than a wait (T4) | Tariff notice dated 2025-12-18: PKR 0.40 rising to PKR 0.65 per session from 2026-10-01, about a 60 percent rise (N62, quoted) | From 2026-10-01, every one of those extra sessions costs PKR 0.65 rather than PKR 0.40, so the flow's own dropped-session handling (the ADR-2 idempotency design, which resumes rather than restarts a session) is worth more after October, because every retry it prevents costs more that day than it would today |
...
| Settle bills over a bank's bill-pay rail whose cut-off posts after-hours or weekend payments the next working day | A payment that posts the next working day reproduces the weekend surcharge this vision exists to remove; a licensed aggregator can post the same day, seven days a week instead (BillBridge's quoted 30-minute SLA, N36). The bank-rail option was tested against this reason and rejected as D3 (2026-04-03) | Darya's cut-off moves past 20:00, seven days a week (D3's own condition) |
