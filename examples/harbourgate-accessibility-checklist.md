...
| Content reflows without two-dimensional scrolling: vertically scrolling content at 320 CSS px wide, horizontally scrolling content at 256 CSS px tall (SC 1.4.10) | 1.4 | zoom to the level's reflow point | HC13, dated test note, open at signature; the accessibility test note will be attached when the walk is run over the existing payment step | Pass | Ines Castellanos |
