...
- Decider: Ife Adeyemi, Product Manager, with Rohan Iyer, Chief Financial Officer and sponsor, co-signing D-024 as budget owner. D-023 (2026-09-14) committed the contract end before Gate 6; D-024 ratified it, and a reversal at Gate 6 would have required withdrawing the notices (owner Anneliese Vogt). What would have reversed it: a Gate 6 review finding decline rates or non-completion worse than the entry baseline, which the 2026-09-08 to 2026-10-05 review window did not find (N18, N19).
...
| InfoSec / PCI DSS assessment scope (Hamid Qureshi) | 7 systems in scope at entry, target 3 after sunset (N55) | No revenue; assessment cost and audit burden | PCI DSS is an industry standard reaching Harbourgate as merchant of record through its acquiring contracts, not through a financial regulator, and not through any regulator at all: the one regulator this journey names anywhere, the ICO under UK GDPR (compliance impact assessment, section 2), governs the personal-data retention and deletion rows in that assessment, not PCI scope; the assessor is booked by 2026-11-20 (DEP-7) but the assessment itself runs after the 2026-12-15 sunset, since a 3-system scope cannot be evidenced before the sunset that creates it; a revalidated scope and updated Attestation of Compliance are submitted to Kestrel, the remaining acquirer, after that assessment; an external assessor was chosen by Hamid Qureshi as a G3 condition, not mandated by the scope change itself | no (no regulator; contractual revalidation) |
...
| InfoSec / PCI DSS scope | Revalidated scope on Kestrel alone | Complete DEP-7's assessment; submit the revalidated scope and updated AOC to Kestrel | assessor booked by 2026-11-20 (DEP-7); assessment held after 2026-12-15; revalidated scope and AOC to Kestrel after it, date [OPEN: Hamid Qureshi] | External assessor booked under DEP-7 | Hamid Qureshi, Information Security Lead |
...
| Compliance impact assessment re-verified for the sunset | before 2026-12-15 | Anneliese Vogt, Hamid Qureshi; G3 stays open until DEP-7's post-sunset assessment | pending |
