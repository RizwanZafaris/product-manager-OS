...
| Lena Baptiste | Head of Store Operations, 61 shops and their kiosks | L at Gate 2, M by Gate 6 (see section 4) | H | A | Signed the kiosk SLO (N32) and BR-004 at Gate 2 attempt 2, 2026-04-07; no standing cadence until the store cohorts were scoped, then weekly through the store cohorts, continuing on R11 (kiosk fallback usage) through its 2026-10-23 review | "My name has been on the kiosk SLO since April and nobody has shown me what the cutover does to a shop at opening. Sixty-one shops, and the earliest opens at eight" (2026-06-25, cutover plan v2 drafted, N1, N32, N48, BR-004) |
