...
- **What would change our mind:** the 2026-09-07 DISCOVER pass, centred on Rafiq, finding agent-assisted bill pay does not hold up either.
- **Reverses or is reversed by:** none.
- **Who was told:** Gate 6 attempt 1 sign-off, 2026-08-28; the review circulated the same day to Faisal Mirza, Zainab Qureshi, Tariq Sohail, Amna Rasheed, Bilal Hasan and Naveed Akhtar.
...
- **What would change our mind:** completion back above 90 percent for a full week with the timeout fix verified, which closed the pause on 2026-07-14.
- **Reverses or is reversed by:** none; delays but does not reverse D6.
- **Who was told:** the on-call channel and Tariq Sohail, owner of the Gate 5 float-hotline condition, both 2026-07-10; logged against the guardrail row in the north star sheet.
...
- **Decision and rationale:** B. A day-one nationwide launch risked R1 at national scale before the hotline existed; holding the whole launch traded a bounded pilot risk for an open-ended delay against the board's year-end key result. Given up: three weeks of nationwide key-result movement and one cutover instead of two.
- **Evidence it rested on:** premortem risk R1, 2026-04-08, and the Gate 5 attempt 1 condition itself.
- **What would change our mind:** the pilot district showing a guardrail breach the hotline could not have prevented.
- **Reverses or is reversed by:** none.
...
- **Type:** scope
- **Context:** on 2026-05-19, three of ten Mehran Water test bills failed reference validation, five weeks before Gate 4, while Ravi Power and Chenab Gas passed the same suite cleanly.
...
- **Type:** vendor
- **Context:** Darya Bank's term sheet, 2026-03-30, offered a ready API and 210 billers against BillBridge's 160, with Zainab Qureshi estimating Darya would ship about nine weeks sooner. The [payments acquiring](../knowledge/domains/payments-acquiring.md) card's question, what happens when a payment is approved and fulfilment fails afterward, sharpened the comparison: BillBridge posts within 30 minutes, seven days a week, with T+1 settlement.
...
- **Reverses or is reversed by:** none. The structural half of this call is filed once as [ADR-1](../templates/architecture/adr.md), linked rather than duplicated here.
- **Who was told:** engineering standup and the sponsor sync, both 2026-04-03; folded into the one-pager's not-doing list at its 2026-05-21 amendment.
...
- **Decision and rationale:** A, decided by Hira Baig as document owner, with Amna's objection recorded rather than resolved by vote. One squad, one release, and a change routed through the existing trust-account sub-ledger argued for the lighter weight; the regulatory question was resolved separately, by a compliance memo rather than by promoting the whole document. Given up: the fuller audit trail a BRD/FRD pair would have produced, for reaching Gate 2 about three weeks sooner.
- **Evidence it rested on:** the stakes-audience-reversibility test itself; no data resolves this against a live objection, so it is judgment under a standing dissent.
- **What would change our mind:** the compliance memo finding bill pay outside the licence's permitted activities.
- **Reverses or is reversed by:** none.
- **Who was told:** the DEFINE kickoff, 2026-03-05, Amna's objection minuted; resolved by her compliance memo, needed 2026-05-29, delivered 2026-05-22.
...
- **Decision and rationale:** B. Bill pay had a named trigger and an arithmetic-shown cost of inaction the promotion did not; the promotion rested on the same untested balance-keeping behavior, so testing it first was cheaper than building on it. Given up: about six weeks a promotion could have run before the same-quarter board review.
...
|---|---|---|---|---|
| Gate 1: Problem worth solving | 2026-02-27 | 1 (D1) | 0 | 0 |
| Gate 2: Requirements signed off | 2026-03-25 | 3 (D1, D2, D4) | 0 | 0 |
...
No entry has been marked superseded by circumstance. D8's pivot narrows what the team is trying to prove about how a bill gets paid, but does not undo the vendor call in D3, the pricing call in D4, or the sequencing call in D6, each of which is argued in its own entry to survive the pivot on its own terms. D8 explicitly does not reverse D1: bill pay remains the product bet, only its funding mechanism changes.
...
- [x] Structural technology decisions are in [ADRs](../templates/architecture/adr.md), linked rather than duplicated here: ADR-1 linked from D3; ADR-2 and ADR-3 named in section 3's opening note as decisions this log correctly never logged.
