# Discovery Synthesis: Ledgerline commercial pass

Fills [templates/discovery/discovery-synthesis.md](../templates/discovery/discovery-synthesis.md). Everything here is invented: Ledgerline is a fictional company, the Expense Copilot is a fictional product, and every person, count, date and segment is ILLUSTRATIVE, carried from the [journey data sheet](ledgerline-journey.md) and the [coverage sheet](ledgerline-coverage-sheet.md).

**Owner:** Maya Chen, Product Manager · **Date:** 2026-10-28 · **Research plan:** [Ledgerline journey data sheet](ledgerline-journey.md) and [Ledgerline coverage sheet](ledgerline-coverage-sheet.md)

## 1. Research question

- **The question this research set out to answer:** Whether Business-plan accounts active in Expenses have a commercial problem worth positioning an Expense Copilot add-on around, and which customer-described themes should feed that positioning under D1.
- **What it did NOT set out to answer:** It did not establish a price, prove willingness to pay, or validate customer-account product quality. The six interview notes were paraphrases, and 0 of 6 interviewees were asked a price. These findings are leads for positioning, not conclusions about conversion or price.
...
| Why | The synthesis covers 9 sources, including 6 interviews, a platform pull, a rep-sourced win-loss batch and a ticket pull. The sources cover the 2,900-account S-1 segment and identify the 1,240-account S-5 best-fit segment. Confidence is limited because the interview notes are paraphrases, the win-loss source is rep-sourced, and 0 of 6 interviewees were asked a price. |
| What would raise it | Ask a new set of customer finance leads for a concrete price response, while recording verbatim notes and separating S-5 from the 1,660 S-1 accounts outside S-5. The next pass should also test whether the spreadsheet and second-vendor themes recur outside the six design partners. |

## 5. Implications

| Theme | Implication | Feeds | Owner |
|---|---|---|---|
| TH-1 | Position the Expense Copilot around reducing reviewer re-checks inside the Expenses workflow. Keep the 66% S-1 median as context, not as a promised improvement. | [positioning](ledgerline-positioning.md) | Tomas Lindqvist |
| TH-2 | Name the shadow spreadsheet as a current workaround and explain what the in-workflow draft replaces. Do not claim every account uses one. | [positioning](ledgerline-positioning.md) | Tomas Lindqvist |
| TH-3 | Position the existing Ledgerline workflow against a separate receipt-capture vendor, including the onboarding and workflow cost of a second vendor. | [positioning](ledgerline-positioning.md) | Tomas Lindqvist |
| TH-4 | Keep "would pay something" as an unpriced lead only. Do not use it to set a price or forecast conversion. Park the theme for a priced follow-up because 0 of 6 were asked a price and 1,660 S-1 accounts sit outside S-5. | parked because the commercial pass did not test price | Maya Chen |

## Exit gate

This synthesis is fit to frame problems from when:

- [x] Every theme states its source count against the total, and totals are in section 2
- [ ] Every theme carries a verbatim quote with a source ID, and every source an evidence note. The box remains unticked because EV-C01 to EV-C06 are paraphrased notes and no transcript or verbatim quote was retained. Each source is linked to the journey or coverage data sheet instead.
- [x] Interpretation is visibly separated from what sources actually said
- [x] Contradicting evidence is recorded per theme, or "none observed" is honestly true
- [x] Confidence is stated with reasons and the next cheapest evidence named
- [x] Every theme feeds a named artifact or is parked with a reason

Signed: Maya Chen, Product Manager, 2026-10-28
