...
**DELIVER (2026-11-06 to 2026-11-22).** The GTM plan and the sales enablement one-pager were signed on 2026-11-06, and the dashboard approved on 2026-11-06 and signed after verification on 2026-11-13, with the add-on's Gate 5, held on the internal PERSIST. Phase 1 put six design partners live on 2026-11-10; four of six met the exit condition by 2026-11-23, with 54% of eligible reports drafted and 77% approved first time. The advisory board was chartered on 2026-11-10.

**OPERATE, add-on (2026-11-23 to 2026-12-22).** Phase 2 was the pricing experiment: the per-seat offer, plain or anchored against the reviewer's hourly cost, shown to 2,748 accounts between 2026-11-23 and 2026-12-04. The status report for the week of 2026-11-30, early in this stretch, is AMBER overall, with one RED: the customer DPA did not cover the model subprocessor, and two Enterprise deals waited on it until D5 on 2026-12-03. The advisory board met on 2026-12-02 and six of eight members said seat pricing penalises accounts with few filers. Hana Sato ran six win-loss interviews between 2026-12-07 and 2026-12-16. On 2026-12-18 the experiment's own rule killed the price. The metrics review on 2026-12-21 returned PIVOT on packaging (D6), the OKRs were scored the same day, and the growth plan of 2026-12-22 queued the usage-based re-offer as the next bet (D7).
...
| N9 | Model API price | $0.22 per receipt, quoted at about 40,000 receipts a year; derived from N8: $733 a month x 12 over about 40,000 receipts | business case Open item; procurement owns the contracted price (DEP2) | quoted, not contracted |
...
| N65 | Reports in active add-on accounts, window | 1,180 eligible; 555 drafted (47%, M-003); 422 approved first time (76%, M-006); north star M-001 = 422 (window count reported under M-001, not a calendar-month value); companion M-012 = 422 / 1,180 = 36% | product analytics joined to platform approval events | measured |
...
| N67 | M-008, M-009, M-010, window | 2.4 errors per 100 drafted reports; $0.93 model cost per drafted report; 5.1 support tickets per 100 add-on accounts per week | reviewer flags; vendor invoice over drafted count (invoice posted 2026-12-21, before the review); support system | measured |
| N68 | Add-on MRR (M-011) at 2026-12-18 | $15,906 = 73 paid accounts, 2,480 seats x $6 = $14,880, plus 6 partners, 228 seats x $6 x 0.75 = $1,026 | billing | measured |
...
| N73 | KR4, add-on MRR | baseline $0; target $30,000; actual $15,906; score 0.53; aspirational | OKR sheet | target; measured |
...
| N77 | Win-loss pattern | 4 of 6 (WL-01, WL-04, WL-05, WL-06) named the seat-priced total as an obstacle: seats billed for people who never file (WL-01, WL-04), a total above the plan (WL-06) or above the buyer's own budget (WL-05); both wins had filers at 70% or more of seats | win-loss review section 4 | measured |
...
| N88 | Calendar cost of the failed price | about 7 weeks (48 days) from D3 (2026-11-03) to D6 (2026-12-21); phase 3 held; 2 Enterprise quotes withdrawn | journey Decisions table (D3, D6); metrics review section 5 | measured |
...
| N90 | Usage price for the median account | 7 x $2.40 = about $16.80 a month at the median account's 7 reports filed a month, about 11% of the plan price, if every filed report were drafted; about $7.90 a month at the observed 47% drafted share (N65, M-003) | derived from N33 and N89 | derived |
| N91 | EXP-2 design | re-offer to about 2,818 to 2,821 S-1 accounts not paying: 2,675 exposed non-converters plus 152 never exposed, less the 6 design partners (S-2) and up to 3 G-1 manual-invoice activations; single arm; success at 6.0% or more reaching paid status (M-007) within 14 days of exposure; iterate band 4.0% to 6.0%, owner Maya Chen with Tomas Lindqvist; planned exposure from 2027-01-11 once DEP4 lands, closing 2027-01-29 | growth plan section 4 | pre-declared 2026-12-22 |
...
| N93 | Price hold for the 73 paid accounts | 12 months at $6 per seat, then migration to a successor price, pending EXP-2; per N48 | pricing doc | decided |
...
| LEDGERLINE-S5 | As an account admin, I can see my account's first-submission approval rate before and after activation | shipped 2026-11-13 as an in-product tile, not on the launch dashboard |
...
| R3 | Foreign-language receipts fail extraction; the RICE sheet's row 7 open item | P2 Priya Nair | 2026-09-01 (RICE) | realised at Wrenfield (N45); eval set scored 2026-12-11 (N83); decision due 2026-12-11 not taken (D9); owner Priya Nair with Maya Chen; open |
...
| D3 | Value metric is plan seats at $6 per seat per month; north star mismatch accepted because billing already held each account's plan seat count and sales forecasts in seats; the add-on seat meter still had to be built (DEP1, N86); reopens on the EXP-1 kill rule or a win-loss pattern naming seats | P4 Isabel Ferreira | 2026-11-03 | per drafted report (no usage meter existed, DEP4, 1 person-month, N87; no add-on seat meter existed either, DEP1); per active filer (no definition agreed) |
...
| D6 | Kill the per-seat price per the EXP-1 rule; PIVOT packaging to a usage metric; hold phase 3; swap the offer page to N94; reopen the pricing doc; withdraw the one-pager's pricing section | P4 Isabel Ferreira, on the metrics review | 2026-12-21 | iterate the anchor copy (rejected: both arms were under the kill line); persist with discounts (rejected: N48 allows none beyond the two standing rules without Isabel Ferreira and a decision-log entry, and a discount does not fix a value-metric mismatch) |
...
| D8 | Accept Cinderwick trial-first losses as a loss type; no roadmap action | P8 Hana Sato | 2026-12-17 | chase the loss as if it were price-driven (rejected: the trial predates the copilot offer entirely) |
| D9 | German-language receipts: decision due 2026-12-11, not taken | P2 Priya Nair with P1 Maya Chen | 2026-12-11 (due; not taken) | exclude German-language accounts from the offer; fund the extraction fix; neither chosen, still open |
...
**Dashboard tiles (T).** T-1 to T-12, one per metric id M-001 to M-012, defined in the dashboard spec section 3.
...
| 2026-08-13 | Business case written; approved at Gate 1 with the GO on 2026-08-14 | [business case](ledgerline-business-case.md) |
...
| 2026-10-12 | Copilot live for Ledgerline's own filers | internal release readiness (not reproduced); N16 only |
...
| 2026-11-04 | Metrics dictionary agreed; ADR-007 | metrics dictionary; ADR-007 in pricing and packaging section 1 |
| 2026-11-05 | Experiment brief signed; sizing computed; 14 account executives briefed | experiment brief; GTM plan phase 1 row; status report |
| 2026-11-06 | GTM plan signed; sales one-pager approved; dashboard spec approved; add-on Gate 5 signed with phase 1 held on the internal review | GTM plan, sales one-pager, dashboard spec |
...
| 2026-11-13 | Dashboard built and verified; LEDGERLINE-S5 shipped | dashboard spec |
...
| 2026-12-03 | D5: DPA terms accepted; R4 closed | journey Decisions table; sales one-pager section 4 update |
| 2026-12-04 | EXP-1 exposure period ends; R2 mitigated | experiment brief; metrics review section 4 |
| 2026-12-07 to 2026-12-16 | Win-loss interviews WL-01 to WL-06 | win-loss review |
| 2026-12-11 | DEP5 delivered; German-language eval set scored 71% (N83) | metrics dictionary G-3; journey R3 row |
...
- **Win-loss review:** interview the buyer, not the admin. The admin forwarded the offer and stepped out; the buyer said "forty-eight seats times six dollars," and only the second sentence names the fix.
- **Feedback program:** a board with one decision to inform produced the first signal about two weeks before the data did, and the capture rule put it in the evidence base where the metrics review could cite it, with no automatic priority and none needed.
