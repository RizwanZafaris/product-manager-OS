...
3. **Check the router.** If a skill in `skills/` covers the request, follow that SKILL.md exactly. Triggering lives here and in CLAUDE.md, never inside the skill. Three routes sit outside `skills/`: "learn", "teach me", or "quiz me" routes to the tutor at [learn/skills/tutor/SKILL.md](learn/skills/tutor/SKILL.md); "which domain" or "domain pack" routes to [knowledge/domains/INDEX.md](knowledge/domains/INDEX.md); "what does a <title> do" or any role-scope question routes to [knowledge/roles/INDEX.md](knowledge/roles/INDEX.md).
